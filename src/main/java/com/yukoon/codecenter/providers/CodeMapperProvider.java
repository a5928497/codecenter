...
public class CodeMapperProvider {
    ...
    public String insertAll(Map map) {
        ...
        sb.append("INSERT INTO codes (code,status,reward_id,record_id) VALUES");
    ...
    public static void main(String[] args) {
        Code code1 = new Code().setCode("123123").setStatus(1).setReward_id(1).setRecord_id(1);
        Code code2 = new Code().setCode("sdfdsfd").setStatus(1).setReward_id(1).setRecord_id(1);
